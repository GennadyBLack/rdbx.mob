...
const auth = {
  register: async (data) => api.post("auth/register_one_user", data),
  ...
  login: async (data) => api.post("auth/login_one_user", data),
  logout: async (data) => api.post("auth/logout_one_user", data),
  refresh_token: async (data) => api.post("auth/refresh_auth_token", data),
};
